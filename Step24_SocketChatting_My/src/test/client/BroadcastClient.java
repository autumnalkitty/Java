...
public class BroadcastClient extends JFrame implements ActionListener{
	...
	public BroadcastClient(String ip, String id){
		...
		JScrollPane jsp=new JScrollPane(jta,
				JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,   //수직 스크롤바
		...
		//텍스트 필드에 액션 리스너를 등록하면 엔터키를 눌렀을 때
		//이벤트가 발생한다. 
	...
	public static void main(String[] args) {
		new BroadcastClient("192.168.0.73", "mata");
	}
	@Override
